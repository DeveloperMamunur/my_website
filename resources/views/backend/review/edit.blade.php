<x-app-layout>
    ...
    <section class="main-body">
        ...
        <div class="content main-container">
            ...
            <form action="{{route('review.update', $review->id)}}" method="post" class="form" enctype="multipart/form-data">
                @csrf
                @method('put')
                <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                <div class="form_group">
                    <label for="name" class="label">Name</label>
                    <input type="text" value="{{Auth::user()->name}}" name="name" class="form_control" id="city" {{Auth::user()->name != null ? 'disabled':''}}>
                </div>
                <div class="form_group">
                ...
                <div class="form_group">
                    ...
                    <textarea name="description" rows="5" class="form_control" id="description" placeholder="Enter Project description">{{$review->description}}</textarea>
                    @error('description')
